/******/ (() => {
      ...
      /***/ (
        ...
        function createModel() {
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        _context.next = 2;
                        return fetch(
                          "https://api.weatherapi.com/v1/forecast.json?key=dd718f92e0a245e2932214841232007&q=" +
                            location +
          ...
          function _retreiveData() {
            _retreiveData = _asyncToGenerator(
          ...
          function formObjects(weatherData) {
            ...
            for (var n = 0; n <= 2; n++) {
              ...
              var icon =
                "https:" +
                weatherData.forecast.forecastday[n].day.condition.icon;
              var weather =
                weatherData.forecast.forecastday[n].day.condition.text;
              var temperature =
                weatherData.forecast.forecastday[n].day.avgtemp_c;
              var humidity =
                weatherData.forecast.forecastday[n].day.avghumidity;
  ...
  \*********************/
      /***/ (
        ...
        /* harmony import */ var _assets_favicon_ico__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        function createView() {
          function renderInitialPage() {
            ...
            faviconElement.href =
              _assets_favicon_ico__WEBPACK_IMPORTED_MODULE_0__;
          }
          function returnCardHtml(weatherObject, location) {
            return '<div class="card">\n    <p>'
              .concat(location, "</p>\n    <p>")
              .concat(weatherObject.date, '</p>\n    <img src="')
              .concat(weatherObject.icon, '"</p/>\n    <p>')
              .concat(weatherObject.weather, "</p>\n    <p>")
              .concat(weatherObject.temperature, "\xB0C</p>\n    <p>Humidity: ")
              .concat(weatherObject.humidity, "%</p>\n    <p>Wind: ")
              .concat(weatherObject.wind, "km/h</p>\n  </div>");
          }
          ...
          function renderCards(weatherObjects, location) {
            ...
            for (var n = 0; n <= 6; n++) {
              ...
              displayElement.innerHTML += returnCardHtml(
                weatherObjects[n],
                location
              );
            }
      ...
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        var ___CSS_LOADER_URL_IMPORT_0___ = new URL(
          /* asset import */ __webpack_require__(
            /*! ../assets/Oswald-VariableFont_wght.ttf */ "./src/assets/Oswald-VariableFont_wght.ttf"
          ),
...
*/
  ...
  \*************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        module.exports =
          ...
          "Oswald-VariableFont_wght.46d7853f0185f6bf0c93..ttf";
  ...
  \********************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        module.exports =
          __webpack_require__.p + "favicon.96851ba3279201744cc8..ico";
  ...
  \**********************/
    ...
    /* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./styles/main.scss */ "./src/styles/main.scss");
    /* harmony import */ var _model_js__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! ./model.js */ "./src/model.js");
    /* harmony import */ var _view_js__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(/*! ./view.js */ "./src/view.js");
    /* harmony import */ var _controller_js__WEBPACK_IMPORTED_MODULE_4__ =
    ...
    var controller = (0,
    _controller_js__WEBPACK_IMPORTED_MODULE_4__["default"])(model, view);
